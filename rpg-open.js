...
`.trim()  
        ...
        case 'pet':
            ...
            let _pet = `${pickRandom(['phonix', 'griffin', 'naga', 'centaur', 'kyubi'])}`.trim()
            if (global.db.data.users[m.sender].pet > 0) { 
                global.db.data.users[m.sender].pet -= 1
                if (_pet == 'phonix' && phonix > 0) {
                    global.db.data.users[m.sender].potion += 2
                    global.db.data.users[m.sender].makananphonix += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} Makananphonix` : ''}`, m)
                } else if (_pet == 'phonix' && phonix == 0) {
                    global.db.data.users[m.sender].phonix += 1
                    global.db.data.users[m.sender].makananphonix += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet${_pet} ${mknp > 0 ? ` Dan ${mknp} Makananphonix*` : '*'}`, m)
                } else if (_pet == 'griffin' && griffin > 0) {
                    global.db.data.users[m.sender].potion += 2
                    global.db.data.users[m.sender].makanangriffin += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanangriffin` : ''}`, m)
                } else if (_pet == 'griffin' && griffin == 0) {
                    global.db.data.users[m.sender].griffin += 1
                    global.db.data.users[m.sender].makanangriffin += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanangriffin*` : '*'}`, m)
                    } else if (_pet == 'naga' && naga > 0) {
                    global.db.data.users[m.sender].potion += 2
                    global.db.data.users[m.sender].makanannaga += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanannaga` : ''}`, m)
                } else if (_pet == 'centaur' && centaur > 0) {
                    global.db.data.users[m.sender].potion += 2
                    global.db.data.users[m.sender].makanancentaur += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanancentaur` : ''}`, m)
                    } else if (_pet == 'naga' && naga == 0) {
                    global.db.data.users[m.sender].naga += 1
                    global.db.data.users[m.sender].makanannaga += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanannaga*` : '*'}`, m) 
                } else if (_pet == 'centaur' && centaur == 0) {
                    global.db.data.users[m.sender].centaur += 1
                    global.db.data.users[m.sender].makanancentaur += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanancentaur*` : '*'}`, m) 
                } else if (_pet == 'kyubi' && kyubi  > 0) {
                    global.db.data.users[m.sender].potion += 2
                    global.db.data.users[m.sender].makanankyubi += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} Makanankyubi` : ''}`, m)
                } else if (_pet == 'kyubi' && kyubi == 0) {
                    global.db.data.users[m.sender].kyubi += 1
                    global.db.data.users[m.sender].makanankyubi += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanankyubi*` : '*'}`, m)
                } else {
